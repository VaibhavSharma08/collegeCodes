...
sample_submission = pd.read_csv("/Users/vaibhavs/PycharmProjects/collegeCodes/Sem 7/machineVision/Practical 9/plant-pathology-2020-fgvc7/sample_submission.csv")
test = pd.read_csv("/Users/vaibhavs/PycharmProjects/collegeCodes/Sem 7/machineVision/Practical 9/plant-pathology-2020-fgvc7/test.csv")
train = pd.read_csv("/Users/vaibhavs/PycharmProjects/collegeCodes/Sem 7/machineVision/Practical 9/plant-pathology-2020-fgvc7/train.csv")
...
for name in train['image_id']:
    path='/Users/vaibhavs/PycharmProjects/collegeCodes/Sem 7/machineVision/Practical 9/plant-pathology-2020-fgvc7/images/'+name+'.jpg'
    img=cv2.imread(path)
